...
namespace InfimaGames.LowPolyShooterPack
{
	...
	public sealed class Character : CharacterBehaviour
	{
		...
		/// <summary>
		/// The installMagazine equipped on the character's weapon.
		/// </summary>
		...
		private void RefreshWeaponSetup()
		{
			...
			//Get equipped installMagazine. We need this one for its settings!
		...
		{
			//Set installMagazine gameObject active.
